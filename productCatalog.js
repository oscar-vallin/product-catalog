...
document.getElementById("inputButton-type").addEventListener('click', () => {
    processSearchType(document.getElementById('input-type').value)
})

document.getElementById("inputButton-price").addEventListener('click', () => {
